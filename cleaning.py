...
# Paths
DISCOURSE_DIR = "C:\\Users\\Varshith\\OneDrive\\Desktop\\Project_1_2.0\\TDS-Project1-Data\\discourse_json"
MARKDOWN_DIR = "C:\\Users\\Varshith\\OneDrive\\Desktop\\Project_1_2.0\\TDS-Project1-Data\\tds_pages_md"
DB_PATH = "C:\\Users\\Varshith\\OneDrive\\Desktop\\Project_1_2.0\\TDS-Project1-Data\\knowledge_base.db"
    ...
    async def handle_long_text(session, text, record_id, is_discourse=True, max_retries=3):
        ...
        for i, subchunk in enumerate(subchunks):
            ...
            success = await embed_text(
                ...
                is_discourse, 
                max_retries,
                f"part_{i+1}of{len(subchunks)}"  # Identify this as part of a multi-part embedding
            )
            if not success:
